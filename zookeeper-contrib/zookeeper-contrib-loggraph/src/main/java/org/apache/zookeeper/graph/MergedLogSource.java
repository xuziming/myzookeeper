...
public class MergedLogSource implements LogSource {
	...
	private class MergedLogSourceIterator implements LogIterator {
		...
		public MergedLogSourceIterator(MergedLogSource src, long starttime, long endtime, FilterOp filter)
		...
		@SuppressWarnings("unused")
		public MergedLogSourceIterator(MergedLogSource src, long starttime, long endtime)
				throws IllegalArgumentException, FilterException {
