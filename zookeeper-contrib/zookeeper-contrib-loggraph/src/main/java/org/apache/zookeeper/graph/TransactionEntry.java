...
public class TransactionEntry extends LogEntry {
	private static final long serialVersionUID = 2003367185619920841L;
	...
	public String toString() {
		return getTimestamp() + ":::session(0x" + Long.toHexString(getClientId()) + ") cxid(0x"
				+ Long.toHexString(getCxid()) + ") zxid(0x" + Long.toHexString(getZxid()) + ") op(" + getOp()
				+ ") extra(" + getExtra() + ")";
	}
