 ...
 * is loaded, this index is built by adding a mark every n entries. Then when a
 * specific time position is requested from the file, a point at most n-1
 * entries before the time position can be jumped to.
 * 
 */
