...
public class ZooInspectorConnectionPropertiesDialog extends JDialog {
	private static final long serialVersionUID = -7715986156000359406L;

	private final HashMap<String, JComponent> components;

	/**
	 * @param lastConnectionProps                   - the last connection properties
	 *                                              used. if this is the first
	 *                                              conneciton since starting the
	 *                                              applications this will be the
	 *                                              default settings
	 * @param connectionPropertiesTemplateAndLabels - the connection properties and
	 *                                              labels to show in this dialog
	 * @param zooInspectorPanel                     - the {@link ZooInspectorPanel}
	 *                                              linked to this dialog
	 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						LoggerFactory.getLogger().error("An Error occurred loading connection properties from file",
								ex);
						JOptionPane.showMessageDialog(ZooInspectorConnectionPropertiesDialog.this,
								"An Error occurred loading connection properties from file", "Error",
		...
		saveDefaultPropsFileButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					LoggerFactory.getLogger().error("An Error occurred saving the default connection properties file",
							ex);
					JOptionPane.showMessageDialog(ZooInspectorConnectionPropertiesDialog.this,
							"An Error occurred saving the default connection properties file", "Error",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		});
