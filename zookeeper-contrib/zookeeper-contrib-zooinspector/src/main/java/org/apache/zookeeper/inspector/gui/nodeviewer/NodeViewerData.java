...
public class NodeViewerData extends ZooInspectorNodeViewer {
	private static final long serialVersionUID = -857355208896319797L;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.apache.zookeeper.inspector.gui.nodeviewer.ZooInspectorNodeViewer#
	 * getTitle()
	 */
	@Override
				...
				protected void done() {
					...
					try {
						...
						LoggerFactory.getLogger()
								.error("Error retrieving data for node: " + NodeViewerData.this.selectedNode, e);
